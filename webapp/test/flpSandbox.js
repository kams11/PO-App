		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Purchase Order Demo App",
									"targetURL": "#comexamplepodemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplepodemo-display": {
								"semanticObject": "comexamplepodemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.podemo",
									"url": sap.ui.require.toUrl("com/example/podemo")
								}
							}
						}
					}
